<template>
  ...
  >
    ...
    <div
      class="fixed inset-0 z-0 opacity-25 overflow-hidden pointer-events-none"
    >
    ...
    <div class="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      <div
        class="absolute right-[-10%] top-[-10%] w-[50%] h-[50%] rounded-full bg-[#FFDDC1]/50 blur-[80px] will-change-transform"
      />
      <div
        class="absolute left-[-10%] bottom-[-10%] w-[50%] h-[50%] rounded-full bg-blue-300/50 blur-[80px] will-change-transform"
      />
    </div>
    ...
    <div class="relative z-10 max-w-[480px] mx-auto min-h-screen">
      ...
      >
        <div class="px-5 py-3 flex items-center gap-4">
          ...
          <!-- Logo -->
          <svg
            class="h-7 w-auto text-custom-main flex-shrink-0"
          ...
          <!-- Step counter -->
          <span
            class="text-xs text-gray-400 font-medium flex-shrink-0 tabular-nums"
          >
            {{ progressPercent }}%
          </span>
        </div>
      ...
      <div class="relative z-10" :class="showHeader ? 'overflow-hidden' : ''">
        <Transition
          :name="transitionName"
          mode="out-in"
          @after-enter="onStepEnter"
        >
          <!-- ========== SCREEN 1: HOOK ========== -->
          <div v-if="currentStep === 'hook'" key="hook" class="step-content">
            <div
              class="px-5 py-8 min-h-dvh flex flex-col text-center items-center justify-center"
            >
              <!-- Headline -->
              <h1
                ref="hookTitle"
                class="text-[2rem] md:text-4xl lg:text-5xl font-extrabold text-custom-dark leading-[1.1] mb-5 mt-8 opacity-0"
              >
                <span
                  class="inline-block font-black tabular-nums transition-colors duration-200"
                  :style="{ color: hookScoreColor }"
                  >{{ hookAnimatedScore }}+</span
                >
                на SAT<br />с персональным<br /><span class="text-custom-main"
                  >ИИ-тьютором</span
                >
              </h1>
              ...
              <p
                ref="hookSub"
                class="text-base md:text-lg text-gray-500 mb-6 md:mb-8 leading-relaxed opacity-0"
              >
                Пройдите тест и мы просканируем твои знания за 5 минут, найдём
                скрытые пробелы и построим маршрут к ВУЗу мечты.
              </p>

              <!-- Social proof pills -->
              <div
                ref="hookProof"
                class="flex items-center gap-4 md:gap-6 mb-8 opacity-0"
              >
                <div
                  class="flex items-center gap-1.5 bg-white rounded-full px-4 py-2 shadow-sm border border-gray-100"
                >
              ...
              <div ref="hookCta" class="pt-4 opacity-0">
                <button
                  class="btn-3d !text-base md:!text-lg !px-10 !py-4"
                  @click="startQuiz"
                >
                  Получить план &rarr;
                </button>
              ...
              <div ref="hookLogin" class="mt-8 opacity-0">
                <a
                  href="https://qos.plus/login"
                  class="text-sm text-gray-400 hover:text-custom-main transition-colors underline underline-offset-4 decoration-gray-200 hover:decoration-custom-main"
                >
          ...
          <!-- ========== SCREEN 2: EXPERIENCE ========== -->
          <div
            v-else-if="currentStep === 'experience'"
            key="experience"
            class="step-content"
          >
          ...
          <div
            v-else-if="currentStep === 'currentScore'"
            key="currentScore"
            class="step-content"
          >
            <div class="px-5 py-8 min-h-[calc(100dvh-56px)] flex flex-col">
              ...
              <div ref="scoreDisplay" class="text-center mb-8 opacity-0">
                <span
                  class="text-6xl md:text-7xl font-bold text-custom-main tabular-nums score-number"
                >
              ...
              <div ref="scoreSlider" class="px-2 opacity-0">
                ...
                />
                <div
                  class="flex justify-between text-xs text-gray-400 mt-2 px-1"
                >
                  <span>800</span>
                  <span>1200</span>
                  <span>1600</span>
              ...
              <div
                ref="scoreCta"
                class="mt-auto pt-6 flex justify-center opacity-0"
              >
          ...
          <div
            v-else-if="currentStep === 'targetScore'"
            key="targetScore"
            class="step-content"
          >
            <div class="px-5 py-8 min-h-[calc(100dvh-56px)] flex flex-col">
              ...
              <div ref="targetCards" class="space-y-3">
                <button
                  ...
                  :class="
                    answers.targetScore === option.value
                ...
                >
                  ...
                  <div v-if="option.badge" class="target-badge">
                    {{ option.badge }}
                  </div>
                </button>
              </div>
          ...
          <!-- ========== SCREEN 5: DEADLINE ========== -->
          <div
            v-else-if="currentStep === 'deadline'"
            key="deadline"
            class="step-content"
          >
            <div class="px-5 py-8 min-h-[calc(100dvh-56px)] flex flex-col">
              <h2
                class="text-2xl md:text-3xl font-bold text-gray-900 text-center mb-8 md:mb-10"
              >
              ...
              <div ref="deadlineCards" class="space-y-3 md:space-y-4">
                ...
                >
                  ...
                  <div class="flex-1">
                    ...
                    <div
                      v-if="option.days"
                      class="text-sm text-custom-main font-medium mt-0.5"
                    >
            ...
            <div class="px-5 py-8 min-h-[calc(100dvh-56px)] flex flex-col">
              ...
              <div class="flex items-center justify-center gap-2 mb-8 md:mb-10">
                <div class="flex gap-1">
                  <span
                    class="w-4 h-4 rounded border-2 border-custom-main bg-custom-blue flex items-center justify-center"
                  >
                    <svg
                      class="w-2.5 h-2.5 text-custom-main"
                      fill="none"
                      stroke="currentColor"
                      stroke-width="3"
                      viewBox="0 0 24 24"
                  ...
                  <span
                    class="w-4 h-4 rounded border-2 border-gray-200 bg-white"
                  ></span>
                </div>
                <span class="text-xs text-gray-400 font-medium"
                  >Можно несколько</span
                >
              </div>
              ...
              <div ref="painCards" class="space-y-2">
                <button
                  ...
                  :class="
                    answers.pains.includes(option.value)
                      ? 'pain-card-selected'
                      : ''
                  "
                ...
                >
                  <!-- Checkbox -->
                  <span
                    class="pain-checkbox flex-shrink-0"
                    :class="
                      answers.pains.includes(option.value)
                  ...
                  >
                    <svg
                      v-if="answers.pains.includes(option.value)"
              ...
              <Transition name="toast">
                <p
                  v-if="answers.pains.length > 0"
                  class="text-center text-sm text-custom-main font-medium mt-5"
                >
          ...
          <div
            v-else-if="currentStep === 'dailyTime'"
            key="dailyTime"
            class="step-content"
          >
            <div class="px-5 py-8 min-h-[calc(100dvh-56px)] flex flex-col">
            ...
            <div class="px-5 py-8 min-h-[calc(100dvh-56px)] flex flex-col">
              ...
              <div ref="anchorCards" class="space-y-3 md:space-y-4">
                <button
                  ...
                  class="quiz-card w-full text-left opacity-0"
                  :class="
                    answers.anchor === option.value ? 'quiz-card-selected' : ''
                  "
          ...
          <!-- ========== SCREEN 9: LOADER ========== -->
          <div
            v-else-if="currentStep === 'loader'"
            key="loader"
            class="step-content"
          >
            <div class="relative min-h-screen">
              <div
                class="min-h-screen flex flex-col items-center justify-center px-4 py-6 md:py-10"
              >
                <div class="max-w-md w-full">
                  <!-- Pulsing orb with rings -->
                  <div
                    ref="loaderSpinner"
                    class="flex justify-center mb-5 md:mb-8 opacity-0"
                  >
                  ...
                  <div
                    ref="loaderTitle"
                    class="flex justify-center mb-1.5 opacity-0"
                  >
                    <div class="loader-letters">
                      <span
                        v-for="(letter, i) in loaderLetters"
                        :key="i"
                        class="loader-letter"
                  ...
                  <Teleport to="body">
                    <Transition name="popup">
                      ...
                      >
                        ...
                        ></div>
                        <div
                          class="popup-card relative bg-white rounded-2xl p-6 md:p-8 text-center shadow-2xl max-w-sm w-full"
                        >
                          <div
                            class="w-10 h-10 mx-auto mb-4 rounded-full bg-custom-main/10 flex items-center justify-center"
                          >
                            <svg
                              class="w-5 h-5 text-custom-main"
                              fill="none"
                              stroke="currentColor"
                              stroke-width="2"
                              viewBox="0 0 24 24"
                          ...
                          <p
                            class="text-gray-900 font-bold text-base md:text-lg mb-1"
                          >
                            Какой раздел подтянуть первым?
                          </p>
                          <p class="text-gray-400 text-xs mb-5">
                            Это поможет нам расставить приоритеты
                          </p>
                          <div class="flex flex-col gap-2.5">
                            <button
                              ...
                              :class="
                                answers.prioritySection === opt.value
                  ...
                  <div ref="loaderBarWrap" class="mb-4 md:mb-6 opacity-0">
                    ...
                    <div class="flex justify-between items-center mt-2 px-0.5">
                      <p
                        class="text-gray-400 text-[11px] tabular-nums font-medium"
                      >
                        {{ loaderPercent }}%
                      </p>
                      <p
                        class="text-gray-300 text-[10px] tracking-wide uppercase"
                      >
                        подготовка плана
                      </p>
                    </div>
                  ...
                  <div
                    ref="loaderChecklist"
                    class="space-y-1.5 md:space-y-2.5 mb-5 md:mb-8 opacity-0"
                  >
                    <div
                      v-for="(item, i) in loaderChecklistItems"
                      :key="i"
                      class="flex items-center gap-2.5 px-3 md:px-4 py-2 md:py-2.5 rounded-xl transition-all duration-500"
                      :class="
                        loaderPercent >= item.at
                          ? 'bg-white shadow-sm border border-gray-100'
                          : 'opacity-30'
                      "
                    >
                      <div
                        class="w-4 h-4 md:w-5 md:h-5 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-500"
                        :class="
                          loaderPercent >= item.at
                            ? 'bg-emerald-500'
                            : 'bg-gray-200'
                      ...
                      <span
                        class="text-xs md:text-sm transition-colors duration-500"
                        :class="
                          loaderPercent >= item.at
                  ...
                  <div ref="loaderReviews" class="opacity-0">
                    <Transition name="review-fade" mode="out-in">
                      <div
                        ...
                        class="flex items-start gap-2.5 bg-white/80 border border-gray-100 rounded-xl px-3 md:px-4 py-3 shadow-sm"
                      >
                        <div
                          class="flex-shrink-0 w-7 h-7 md:w-8 md:h-8 rounded-full bg-custom-main/10 flex items-center justify-center"
                        >
                          <span class="text-amber-400 text-[10px] md:text-xs"
                            >&#9733;</span
                          >
                        </div>
                        <div class="min-w-0">
                          <p
                            class="text-gray-700 text-xs md:text-sm leading-relaxed"
                          >
                            &laquo;{{ reviews[currentReviewIndex].text }}&raquo;
                          </p>
                          <p
                            class="text-gray-400 text-[10px] md:text-xs mt-1 font-medium"
                          >
          ...
          <div
            v-else-if="currentStep === 'emailCapture'"
            key="emailCapture"
            class="step-content"
          >
            <div class="px-5 pt-14 pb-28 min-h-dvh flex flex-col">
              <h2
                ref="emailTitle"
                class="text-[28px] font-black text-gray-900 text-center leading-tight mb-3 opacity-0"
              >
                Твой результат готов
              </h2>
              <p
                ref="emailSub"
                class="text-[15px] text-gray-500 text-center leading-relaxed mb-6 opacity-0"
              >
                Укажи почту, чтобы сохранить результат и получить персональный
                план подготовки
              </p>
            ...
            <div
              ref="emailCta"
              class="fixed bottom-0 left-0 right-0 z-50 opacity-0"
            >
              <div class="max-w-[480px] mx-auto px-5 pb-6 pt-3 text-center">
                ...
                <p class="text-[12px] text-gray-400 mt-2">
                  Добавление почты подтверждает ваше согласие с
                  <a
                    href="/terms"
                    target="_blank"
                    class="underline hover:text-custom-main transition-colors"
                    >публичной офертой</a
                  >
                  и
                  <a
          ...
          >
            <div class="px-5 pt-14 pb-28 min-h-dvh flex flex-col">
              ...
              <div ref="resultCard" class="relative mb-4 opacity-0">
                <div
                  class="bg-white rounded-2xl p-4 border border-gray-100 border-b-2 border-b-gray-200 shadow-sm"
                >
                  <svg
                    class="w-full"
                    viewBox="0 0 460 240"
                  ...
                  >
                    <defs>
                      ...
                      <clipPath id="resultChaosClip">
                        <rect
                          ref="resultChaosClipRect"
                          x="0"
                          y="0"
                          width="0"
                          height="240"
                    ...
                    <path
                      ...
                      clip-path="url(#resultChaosClip)"
                    />

                    <!-- System line -->
                    <line
                      ref="resultSystemPath"
                      x1="50"
                      y1="200"
                      x2="340"
                      y2="35"
                      stroke="url(#resultSystemGrad)"
                      stroke-width="3"
                      stroke-linecap="round"
                      stroke-dasharray="380"
                      stroke-dashoffset="380"
                      filter="url(#resultLineGlow)"
                    />
                    ...
                    <g ref="resultChaosLabel" opacity="0">
                      <text
                        :x="resultChaosEnd.x + 12"
                        :y="resultChaosEnd.y + 4"
                        text-anchor="start"
                        font-size="13"
                        font-weight="800"
                        fill="#EF4444"
                    ...
                    <g ref="resultChaosEndLabel" opacity="0">
                      <text
                        :x="resultChaosEnd.x - 2"
                        :y="resultChaosEnd.y - 18"
                        text-anchor="end"
                        font-size="10"
                        font-weight="600"
                        fill="#9CA3AF"
                      ...
                      >
                        ~{{
                          Math.round(
                            (answers.currentScore +
                              (answers.targetScore - answers.currentScore) *
                                0.4) /
                              50,
                          ) * 50
                        }}
                ...
                <!-- Start label -->
                <div
                  ref="resultStartLabel"
                  class="absolute z-10"
                  style="left: -4px; bottom: -12px"
                >
                  <div
                    class="bg-red-50 border border-red-100 px-3 py-1.5 rounded-xl"
                  >
                    <span
                      class="block text-[9px] font-semibold text-red-400 tracking-widest uppercase"
                      >Старт</span
                    >
                    <span
                      class="block text-lg font-extrabold text-red-600 leading-tight"
                      >{{ answers.currentScore }}</span
                    >
                  </div>
                </div>
                ...
                >
                  <div
                    class="bg-emerald-50 border border-emerald-100 px-3 py-1.5 rounded-xl"
                  >
                    <span
                      class="block text-[9px] font-semibold text-emerald-400 tracking-widest uppercase"
                      >Цель</span
                    >
                    <span
                      class="block text-lg font-extrabold text-emerald-600 leading-tight"
                      >{{ answers.targetScore }}+</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div
                ref="resultBadgeEl"
                class="flex justify-center mb-5 opacity-0"
              >
                <div
                  class="inline-flex items-center gap-1.5 bg-emerald-50 text-emerald-600 text-sm font-semibold px-4 py-2 rounded-full border border-emerald-100"
                >
                  <svg
                    class="w-4 h-4"
                    fill="none"
                  ...
                  +{{
                    (answers.targetScore || 1300) - answers.currentScore
                  }}
                  баллов
                </div>
              </div>
              ...
              <div ref="resultRows" class="space-y-2 mb-5 opacity-0">
                <div
                  v-if="daysUntilExam"
                  class="flex items-center gap-3 bg-white rounded-xl px-4 py-3 border border-gray-100 border-b-2 border-b-gray-200 shadow-sm"
                >
                  <span class="text-lg">📅</span>
                  <span class="text-sm text-gray-700 font-medium"
                    >{{ daysUntilExam }} дней до экзамена</span
                  >
                </div>
                <div
                  v-if="answers.pains.length"
                  class="flex items-center gap-3 bg-white rounded-xl px-4 py-3 border border-gray-100 border-b-2 border-b-gray-200 shadow-sm"
                >
                  <span class="text-lg">🎯</span>
                  <span class="text-sm text-gray-700 font-medium"
                    >Фокус:
                    {{
                      answers.pains.slice(0, 2).map(painLabel).join(", ")
                    }}</span
                  >
                </div>
                <div
                ...
                >
                  <span class="text-lg">⏱</span>
                  <span class="text-sm text-gray-700 font-medium"
                    >{{ timeLabel(answers.dailyTime) }} ежедневных занятий</span
                  >
                </div>
              </div>
              ...
              <!-- Motivation -->
              <div
                ref="resultMotivation"
                class="bg-custom-blue rounded-xl px-4 py-3 mb-5 opacity-0"
              >
                <p class="text-sm text-custom-main font-medium text-center">
                  {{ anchorMotivation }}
                </p>
              </div>
              ...
              <div
                ref="resultSocial"
                class="flex items-center justify-center gap-3 mb-4 opacity-0"
              >
                <div class="flex -space-x-2">
                  <div
                    class="w-6 h-6 rounded-full bg-custom-main text-white text-[10px] font-bold flex items-center justify-center ring-2 ring-white"
                  >
                    A
                  </div>
                  <div
                    class="w-6 h-6 rounded-full bg-indigo-500 text-white text-[10px] font-bold flex items-center justify-center ring-2 ring-white"
                  >
                    K
                  </div>
                  <div
                    class="w-6 h-6 rounded-full bg-purple-500 text-white text-[10px] font-bold flex items-center justify-center ring-2 ring-white"
                  >
                    M
                  </div>
                </div>
            ...
            >
              <div class="max-w-[480px] mx-auto px-5 pb-6 pt-3 text-center">
                <button
                  class="btn-3d w-full !text-base !py-4"
                  @click="goToFeatureShowcase"
                >
                  Начать подготовку &rarr;
                </button>
                <p class="text-xs text-gray-400 mt-2">
                  Бесплатно &middot; Без обязательств
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            v-else-if="currentStep === 'featureShowcase'"
            key="featureShowcase"
            class="step-content"
          >
            <div class="px-5 pt-14 pb-28 min-h-dvh flex flex-col">
              ...
              <div
                ref="featSub"
                class="flex flex-col items-center justify-center gap-0 mb-3 opacity-0"
              >
                <img
                  src="/jhu-logo.svg"
                  ...
                  class="h-[50px] w-auto"
                />
                <span class="text-[15px] font-medium text-gray-600 mt-1"
                  >Создано студентами Johns Hopkins · Методология College
                  Board</span
                >
              </div>
              ...
              <div
                ref="featHero"
                class="feat-hero-card rounded-2xl p-5 mb-4 opacity-0"
              >
                <div class="flex items-start gap-3 mb-2">
                  <span class="text-2xl leading-none mt-0.5">🎯</span>
                  <h3 class="text-[20px] font-bold text-gray-900 leading-snug">
                    Система знает, где ты теряешь баллы
                  </h3>
                </div>
                <p
                  class="text-[15px] text-gray-500 leading-relaxed mb-3 pl-[42px]"
                >
                  Находит слабые темы и даёт задания именно по ним.
                </p>
                <div class="pl-[42px]">
                  <span
                    class="inline-flex items-center gap-1.5 bg-emerald-50 text-emerald-600 text-[13px] font-bold px-3 py-1.5 rounded-full border border-emerald-100"
                  >
                    <svg
                      class="w-3.5 h-3.5"
                      fill="none"
              ...
              <div ref="featGrid" class="space-y-2.5">
                <div class="feat-secondary-card opacity-0">
                  ...
                  <div class="flex-1 min-w-0">
                    <h4 class="font-bold text-[15px] text-gray-900 mb-0.5">
                      Твой план на каждый день
                    </h4>
                    <p class="text-[14px] text-gray-500 leading-relaxed">
                      Не нужно думать, что делать. Открыл — задания ждут. 30
                      минут — и день закрыт.
                    </p>
                  </div>
                </div>
                <div class="feat-secondary-card opacity-0">
                  ...
                  <div class="flex-1 min-w-0">
                    <h4 class="font-bold text-[15px] text-gray-900 mb-0.5">
                      Разбор каждой ошибки с AI
                    </h4>
                    <p class="text-[14px] text-gray-500 leading-relaxed">
                      AI не даёт ответ, а ведёт к пониманию. Как репетитор.
                    </p>
                  </div>
                </div>
                <div class="feat-secondary-card opacity-0">
                  ...
                  <div class="flex-1 min-w-0">
                    <h4 class="font-bold text-[15px] text-gray-900 mb-0.5">
                      Слово непонятно? Одно нажатие
                    </h4>
                    <p class="text-[14px] text-gray-500 leading-relaxed">
                      Добавь в карточки — AI даст значение. Система напомнит
                      повторить.
                    </p>
                  </div>
                </div>
                <div class="feat-secondary-card opacity-0">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <p class="text-[14px] text-gray-500 leading-relaxed">
                      Вопросы не заканчиваются. База обновляется, уровень
          ...
          <div
            v-else-if="currentStep === 'socialProofWall'"
            key="socialProofWall"
            class="step-content"
          >
            <div class="px-5 pt-14 pb-28 min-h-dvh flex flex-col">
              <h2
                ref="spwTitle"
                class="text-[28px] font-black text-gray-900 text-center leading-tight mb-5 opacity-0"
              >
                Они уже это сделали
              </h2>
              <!-- Metrics row -->
              <div ref="spwMetrics" class="flex gap-2 mb-6 opacity-0">
                <div
                  class="flex-1 text-center bg-white rounded-xl py-3 border border-gray-100 border-b-2 border-b-gray-200 shadow-sm"
                >
                  <div class="text-2xl font-extrabold text-custom-main">
                    <span ref="spwCounter89">0</span>%
                  </div>
              ...
              <div ref="spwReviews" class="space-y-2.5 mb-5 opacity-0">
                <!-- Review 1: Адилет -->
                <div
                  class="bg-white rounded-xl px-4 py-3 border border-gray-100 border-b-2 border-b-gray-200 shadow-sm"
                >
                  <div class="flex items-center gap-2.5 mb-2">
                    ...
                    <div class="flex-1 min-w-0">
                      <p
                        class="font-bold text-[14px] text-gray-900 leading-tight"
                      >
                        Адилет
                      </p>
                      <div class="text-amber-400 text-[10px] leading-tight">
                        ★★★★★
                      </div>
                    </div>
                    <span
                      class="bg-emerald-50 text-emerald-600 text-[11px] font-bold px-2 py-0.5 rounded-md whitespace-nowrap"
                      >1210 → 1540</span
                    >
                  </div>
                  <p class="text-[13px] text-gray-600 leading-snug">
                    «Занимался по 40 минут в день, даже не напрягался особо.
                    Через 2 месяца — 1540. Сам в шоке.»
                  </p>
                </div>
                <!-- Review 2: Айганым -->
                <div
                ...
                >
                  ...
                  <p class="text-[13px] text-gray-600 leading-snug">
                    «Мне говорили что 1500+ нереально без репетитора. Ну вот,
                    1520)) Спасибо за разборы ошибок, реально помогло»
                  </p>
                </div>
                <!-- Review 3: Арнур -->
                <div
                ...
                >
                  ...
                  <p class="text-[13px] text-gray-600 leading-snug">
                    «Раньше не знал за что браться, тут просто открываешь и
                    делаешь. За 3 месяца с 1260 до 1530 дошёл»
                  </p>
                </div>
              </div>
              ...
              <div ref="spwUnis" class="mb-4 opacity-0">
                <p class="text-[13px] text-gray-400 text-center mb-3">
                  Наши ученики поступили в:
                </p>
          ...
          >
            <div class="px-5 pt-14 pb-28 min-h-dvh flex flex-col">
              ...
              <h2
                ref="hubTitle"
                class="text-[28px] font-black text-gray-900 text-center leading-tight mb-2 opacity-0"
              >
              ...
              <div ref="hubSub" class="text-center mb-5 opacity-0">
                <p
                  class="text-[17px] font-semibold text-gray-700 leading-snug mb-1.5"
                >
                  QOS Hub — закрытое комьюнити для тех, кто поступает в топ-вузы
                  мира
                </p>
                <p class="text-[13px] text-gray-400">
                  Бесплатно при подписке QOS Plus · Навсегда
                </p>
              </div>
              ...
              <div
                ref="hubHero"
                class="rounded-2xl p-5 mb-5 opacity-0"
                style="background: linear-gradient(145deg, #082cae, #1e40af)"
              >
                <!-- Fake chat bubbles -->
                <div class="space-y-2 mb-4">
                  <div class="flex items-end gap-2">
                    <div
                      class="w-7 h-7 rounded-full bg-white/20 flex items-center justify-center text-[10px] font-bold text-white flex-shrink-0"
                    >
                      A
                    </div>
                    <div
                      class="bg-white/15 rounded-2xl rounded-bl-md px-3.5 py-2 max-w-[75%]"
                    >
                      <p class="text-[12px] text-white/90">
                        Кто-нибудь знает deadlines для Cornell ED? 🤔
                      </p>
                    </div>
                  </div>
                  <div class="flex items-end gap-2 justify-end">
                    <div
                      class="bg-white/25 rounded-2xl rounded-br-md px-3.5 py-2 max-w-[75%]"
                    >
                      <p class="text-[12px] text-white">
                        1 ноября! Я подавала в прошлом году, могу помочь с эссе
                        💪
                      </p>
                    </div>
                    <div
                      class="w-7 h-7 rounded-full bg-emerald-400/30 flex items-center justify-center text-[10px] font-bold text-white flex-shrink-0"
                    >
                      D
                    </div>
                  </div>
                  <div class="flex items-end gap-2">
                    <div
                      class="w-7 h-7 rounded-full bg-amber-400/30 flex items-center justify-center text-[10px] font-bold text-white flex-shrink-0"
                    >
                      M
                    </div>
                    <div
                    ...
                    >
                      <p class="text-[12px] text-white/90">
                        Новый гайд по стипендиям уже в канале! 🔥
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div ref="hubCards" class="space-y-2 mb-5">
                <div
                  class="bg-white rounded-xl px-4 py-3.5 border border-gray-100 border-b-2 border-b-gray-200 shadow-sm flex items-center gap-3 opacity-0"
                >
                  <span class="text-lg flex-shrink-0">🎤</span>
                  <span class="text-[15px] text-gray-800 font-medium"
                    >Эфиры с теми, кто уже поступил</span
                  >
                </div>
                <div
                  class="bg-white rounded-xl px-4 py-3.5 border border-gray-100 border-b-2 border-b-gray-200 shadow-sm flex items-center gap-3 opacity-0"
                >
                  <span class="text-lg flex-shrink-0">📚</span>
                  <span class="text-[15px] text-gray-800 font-medium"
                    >Статьи и гайды каждую неделю</span
                  >
                </div>
                <div
                  class="bg-white rounded-xl px-4 py-3.5 border border-gray-100 border-b-2 border-b-gray-200 shadow-sm flex items-center gap-3 opacity-0"
                >
                  <span class="text-lg flex-shrink-0">👥</span>
                  <span class="text-[15px] text-gray-800 font-medium"
                    >Общайся с теми, кто тоже готовится</span
                  >
                </div>
                <div
                  class="bg-white rounded-xl px-4 py-3.5 border border-gray-100 border-b-2 border-b-gray-200 shadow-sm flex items-center gap-3 opacity-0"
              ...
              <div
                ref="hubAccent"
                class="bg-emerald-50 border border-emerald-100 rounded-xl px-4 py-3 text-center mb-4 opacity-0"
              >
                <p class="text-[14px] text-emerald-700 font-semibold">
                  🎁 Подарок при подписке — доступ навсегда, даже если отменишь
                </p>
              </div>
            </div>
          ...
          >
            <div class="px-5 pt-14 pb-32 min-h-dvh flex flex-col">
              ...
              <p
                ref="pwSub"
                class="text-[15px] text-gray-500 text-center leading-relaxed mb-5 opacity-0"
              >
              ...
              <div
                ref="pwGuarantee"
                class="flex items-center justify-center gap-2 bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3 mb-5 opacity-0"
              >
                <span class="text-lg">🛡️</span>
                <span class="text-[14px] font-semibold text-emerald-700"
                  >Гарантия результата — или вернём деньги</span
                >
              </div>
              ...
              <div ref="pwPlans" class="space-y-3 mb-4 opacity-0">
                ...
                >
                  <div v-if="plan.badge" class="paywall-plan-badge">
                    {{ plan.badge }}
                  </div>
                  <div
                    class="paywall-radio"
                    :class="{
                      'paywall-radio-active': selectedPlan === plan.id,
                    }"
                  >
                    <span
                      v-if="selectedPlan === plan.id"
                      class="paywall-radio-dot"
                    ></span>
                  </div>
                  <div class="flex-1">
                  ...
                  <div class="text-right flex items-center gap-1.5">
                    <span
                      v-if="plan.discount"
                      class="inline-block bg-emerald-600 text-white text-[11px] font-bold px-2 py-0.5 rounded-md"
                      >{{ plan.discount }}</span
                    >
                    <div>
                      <div
              ...
              <div
                ref="pwBonus"
                class="flex items-center justify-center gap-2 mb-4 opacity-0"
              >
                <span class="text-base">🎁</span>
                <span class="text-[13px] text-gray-600 font-medium"
                  >+ QOS Hub — закрытое комьюнити навсегда</span
                >
              </div>
              ...
              <div ref="pwPromo" class="opacity-0">
                <button
                  ...
                  class="text-[13px] text-custom-main font-medium text-center w-full"
                >
                  Есть промокод?
                </button>
                <div v-else class="flex gap-2">
                  <input
                    v-model="promoCode"
                    class="flex-1 border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-custom-main transition-colors"
                    placeholder="Промокод"
                  />
                  <button
                    class="bg-custom-main text-white font-bold text-sm px-5 rounded-xl"
                  >
                    OK
                  </button>
                </div>
              ...
              >
                <div class="max-w-[480px] mx-auto px-5 pb-6 pt-3 text-center">
                  ...
                  <p class="mt-3">
                    <a
                      href="https://qos.plus/login"
                      class="text-[13px] text-custom-main font-medium hover:underline"
                      >Уже оплатил?</a
                    >
                  </p>
                </div>
              ...
              <Transition name="toast">
                <div
                  ...
                  class="fixed inset-0 z-[70] flex items-end sm:items-center justify-center pointer-events-auto"
                  @click.self="showPaymentMethod = false"
                >
                  <div class="absolute inset-0 bg-black/40"></div>
                  <div
                    class="relative bg-white rounded-t-3xl sm:rounded-3xl w-full max-w-md p-6 pb-8 shadow-2xl"
                  >
                    <button
                      @click="showPaymentMethod = false"
                      class="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 text-gray-400 hover:text-gray-600 transition-colors"
                    >
                      <svg
                        class="w-4 h-4"
                        fill="none"
              ...
              <Transition name="toast">
                <div
                  v-if="showAbandonment"
                  class="fixed inset-0 z-[70] flex items-end sm:items-center justify-center pointer-events-auto"
                  @click.self="dismissAbandonment"
                >
                  <div class="absolute inset-0 bg-black/40"></div>
                  <div
                    class="relative bg-white rounded-t-3xl sm:rounded-3xl w-full max-w-md p-6 pb-8 shadow-2xl"
                  >
                    <div
                      class="w-10 h-1 bg-gray-200 rounded-full mx-auto mb-5"
                    ></div>
                    <h3 class="text-[22px] font-black text-center mb-1">
                      Подожди! 🎁
                    </h3>
                    <p class="text-[14px] text-gray-500 text-center mb-5">
                      Специальное предложение — только сейчас
                    </p>

                    <div
                      class="border-2 border-custom-main bg-blue-50 rounded-2xl p-4 text-center mb-3"
                    >
                      <span
                      ...
                      <template v-if="isKZ">
                        ...
                        <div class="text-2xl font-extrabold text-custom-main">
                          19 600 <span class="text-sm font-medium">₸/год</span>
                        </div>
                        <div class="text-[13px] text-gray-500 mt-1">
                          1 633 ₸/мес · экономия 8 400 ₸
                        </div>
                      </template>
                      <template v-else>
                        <div class="text-xs text-gray-400 line-through">
                    ...
                    <button
                      class="btn-3d w-full !text-base !py-4"
                      @click="goToPlatformWithDiscount"
                    >
                      Забрать скидку &rarr;
                    </button>
                    <p
                      class="text-center text-[14px] text-custom-main font-medium mt-4 cursor-pointer"
                      @click="goToPlatform"
                    >
              ...
              <Transition name="toast">
                ...
                >
                  <div class="absolute inset-0 bg-black/40"></div>
                  <div
                    class="relative bg-white rounded-t-3xl sm:rounded-3xl w-full max-w-md p-6 pb-8 shadow-2xl text-center"
                  >
                    <div
                      class="w-10 h-1 bg-gray-200 rounded-full mx-auto mb-5"
                    ></div>
                    ...
                    />
                    <h3 class="text-[22px] font-black mb-2">
                      Подтвердите оплату
                    </h3>
                    ...
                    <div class="flex items-center justify-center gap-2 mb-6">
                      <div
                        class="w-2 h-2 bg-custom-main rounded-full animate-pulse"
                      ></div>
...
const showFloatingBack = computed(() => {
  return (
    NO_HEADER_STEPS.includes(currentStep.value) &&
    !NO_BACK_STEPS.includes(currentStep.value)
  );
});
...
const experienceOptions = [
  {
    ...
    icon: "\u{1F331}",
    label: "Новичок",
    desc: "Еще не начинал подготовку",
  },
  {
    value: "tried",
    icon: "\u{1F4D8}",
    label: "Готовился, но без системы",
    desc: "Решал задания самостоятельно",
  },
  {
    value: "took",
    icon: "\u{1F3AF}",
    label: "Уже сдавал SAT",
    desc: "Есть результат — хочу поднять балл",
  },
];
  ...
  const specific = dates
    ...
    .map((d) => {
      const diff = Math.ceil(
        (new Date(d.date) - today) / (1000 * 60 * 60 * 24),
      );
      return {
        value: d.label,
        days: diff,
...
const painOptions = [
  {
    value: "reading",
    icon: "\u{1F4D6}",
    label: "Сложные тексты на английском",
  },
  { value: "math", icon: "\u{1F4D0}", label: "Теряю баллы на Math" },
  {
    value: "time",
    icon: "\u{23F0}",
    label: "Не хватает времени на подготовку",
  },
...
const anchorOptions = [
  {
    value: "university",
    icon: "\u{1F393}",
    label: "Поступлю в университет мечты",
  },
  {
    value: "abroad",
    icon: "\u{2708}\u{FE0F}",
    label: "Уеду учиться за границу",
  },
...
const reviews = [
  {
    text: "1180 \u2192 1420 за 2.5 месяца. Каждый день по 40 минут — и результат",
    author: "Алихан, Алматы",
  },
  {
    text: "Думал Math не вытяну, в итоге 760. Стратегия решает",
    author: "Давид, Астана",
  },
  {
    text: "С 1050 до 1340. Самое полезное — ежедневные мини-тесты",
    author: "Амина, Шымкент",
  },
  {
    text: "Родители не верили, а я сдала на 1510. Спасибо QOS PLUS!",
    author: "Дана, Алматы",
  },
];
...
const loaderChecklistItems = computed(() => [
  ...
  {
    at: 45,
    text: `Фокус: ${answers.pains.length ? answers.pains.slice(0, 2).map(painLabel).join(", ") : "все разделы"}`,
  },
...
const PAIN_TO_HERO = {
  math: {
    icon: "🧮",
    title: "Математический AI-алгоритм",
    desc: "Наш собственный алгоритм, обученный на тысячах SAT задач. Видит паттерны твоих ошибок и закрывает пробелы.",
    stat: "Средний рост: +120 по Math",
  },
  reading: {
    icon: "🃏",
    title: "Vocabulary Flashcards",
    desc: "2,000+ SAT-слов с интервальным повторением. Система запоминает, какие слова ты знаешь, и фокусируется на пробелах.",
    stat: "+85 баллов по Reading за 6 недель",
  },
  time: {
    icon: "🧠",
    title: "Умный план",
    desc: "Адаптивный план, который экономит время. Каждый день — только то, что двигает балл вверх.",
    stat: "Экономит до 40% времени на подготовку",
  },
  practice: {
    icon: "📝",
    title: "Безлимитные Practice Tests",
    desc: "Полные пробники SAT с детальным разбором каждого ответа. Практикуйся сколько хочешь.",
    stat: "Безлимитный доступ к пробникам",
  },
  motivation: {
    icon: "💬",
    title: "Telegram-комьюнити",
    desc: "Закрытое сообщество студентов. Эфиры, разборы задач, поддержка менторов — ты не один.",
    stat: "2,800+ учеников в сообществе",
  },
};
...
const ALL_SECONDARY_FEATURES = [
  {
    key: "tests",
    icon: "📝",
    title: "Безлимитные тесты",
    desc: "Reading, Writing, Math",
  },
  {
    key: "tracker",
    icon: "📊",
    title: "Трекер прогресса",
    desc: "Рост в реальном времени",
  },
  {
    key: "plan",
    icon: "🧠",
    title: "Умный план",
    desc: "Адаптируется каждый день",
  },
  {
    key: "reflection",
    icon: "🔄",
    title: "Рефлексия",
    desc: "Анализ после сессий",
  },
];
...
const anchorMotivation = computed(() => {
  switch (answers.anchor) {
    case "university":
      return "2,800+ учеников уже готовятся к поступлению с QOS PLUS";
    case "abroad":
      return "Ученики QOS PLUS поступают в вузы 12 стран";
    case "scholarship":
      return "Высокий SAT — твой главный аргумент для стипендии";
    case "self":
      return "89% наших учеников превышают свою цель";
    default:
      return "2,800+ учеников уже занимаются на платформе";
  }
});
...
const daysUntilExam = computed(() => {
  ...
  const diff = Math.ceil(
    (new Date(answers.deadlineDate) - new Date()) / (1000 * 60 * 60 * 24),
  );
...
const targetMotivation = computed(() => {
  switch (answers.targetScore) {
    case 1200:
      return "Четкая цель. За 2-3 месяца реально.";
    case 1300:
      return "Крепкий балл. У нас есть стратегия.";
    case 1400:
      return "Серьезная заявка. 73% наших учеников с такой целью достигают ее.";
    case 1500:
      return "Топ-цель. Мы знаем, как туда добраться.";
    default:
      return "";
  }
});
...
function goNext() {
  ...
  if (currentStep.value === "currentScore") {
    ...
    capture("quiz_pains_selected", {
      pains: answers.pains,
      pains_count: answers.pains.length,
    });
  }
...
function selectDeadline(option) {
  if (isAnimating.value) return;
  capture("quiz_deadline_selected", {
    deadline: option.value,
    deadline_date: option.date,
  });
  answers.deadline = option.value;
...
function updateLoaderStatus(pct) {
  if (pct < 20) loaderStatusText.value = "Анализируем твой уровень...";
    ...
    loaderStatusText.value = `Строим маршрут от ${answers.currentScore} до ${answers.targetScore}...`;
  else if (pct < 60)
    loaderStatusText.value = "Подбираем задания под твои сложности...";
  else if (pct < 80)
    loaderStatusText.value = "Рассчитываем оптимальный темп...";
...
function handlePaywallBack() {
  if (!hasSeenAbandonment.value) {
    capture("quiz_paywall_abandonment_shown", {
...
async function payWithCard() {
  ...
  capture("quiz_payment_initiated", {
    method: "card",
    selected_plan: selectedPlan.value,
...
function startKaspiPolling(token) {
  ...
  kaspiPollInterval = setInterval(async () => {
    ...
    try {
      const res = await fetch(
        `/api/method/lms.lms.landing_api.landing_check_payment_status?token=${encodeURIComponent(token)}`,
      );
      const data = await res.json();
...
const generateResultChaosPath = () => {
  ...
  for (let i = 0; i <= steps; i++) {
    ...
    const wobble =
      Math.sin(t * 20 + i * 0.7) * wobbleAmp * (0.4 + Math.random() * 0.6);
...
const animateResultChart = () => {
  ...
  setTimeout(() => {
    if (resultSystemPath.value) {
      resultSystemPath.value.style.transition =
...
const universities = [
  ...
  { name: "UPenn", short: "UP", logo: "/logos/upenn.svg" },
  {
    ...
    short: "NU",
    logo: "https://static.tildacdn.pro/tild3863-3038-4632-b365-363362373130/NU_horizontal_1.png",
  },
...
function animateHookScore() {
  ...
  const animate = (currentTime) => {
    ...
    const progress = Math.min(elapsed / duration, 1);
    const eased = 1 - Math.pow(1 - progress, 3);
    hookAnimatedScore.value = Math.round(
...
function animateHook() {
  const tl = gsap.timeline({
    defaults: { ease: "back.out(1.4)", duration: 0.35 },
  });
...
function animateSocialProofWall() {
  ...
  tl.to(
    c89,
    {
      ...
      ease: "power2.out",
      onUpdate: () => {
        if (spwCounter89.value)
          spwCounter89.value.textContent = Math.round(c89.val);
      },
    },
    0.15,
  );
  ...
  tl.to(
    c150,
    {
      ...
      ease: "power2.out",
      onUpdate: () => {
        if (spwCounter150.value)
          spwCounter150.value.textContent = Math.round(c150.val);
      },
    },
    0.23,
  );
  ...
  tl.to(
    c49,
    {
      ...
      ease: "power2.out",
      onUpdate: () => {
        if (spwCounter49.value)
          spwCounter49.value.textContent = c49.val.toFixed(1);
      },
    },
    0.31,
  );
